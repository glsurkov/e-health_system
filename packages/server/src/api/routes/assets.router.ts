...
import { AssetNotFoundError } from '../../lib/errors/errors';
import { evatuateTransaction } from '../../external-services/fabric/fabric';
import { addSubmitTransactionJob } from '../../external-services/fabric/jobs';
...
router.options('/:assetId', async (req: Request, res: Response) => {
