...
export const TooltipContent = React.forwardRef<HTMLDivElement, Props>(function TooltipContent(
    ...
    const isZeroComponent = context.followMouse
        ? context.floatingStyles.transform === 'translate(0px, 0px)' || !context.floatingStyles.transform
        : false;
                ...
                {...context.getFloatingProps({
                    ...
                    onMouseLeave: (e) => {
                        ...
                        if (
                            ...
                            (relatedTarget === null || !referenceElement.contains(relatedTarget))
                        ) {
